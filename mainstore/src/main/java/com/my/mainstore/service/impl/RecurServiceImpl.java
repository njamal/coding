...
//String inputDate="8/07/2021";  
	   ...
	   // Date date = new SimpleDateFormat("dd/MM/yyyy").parse(inputDate);
		...
		for(String t : weeklyInvoiceDate) {
			System.out.println("A ::: " +weeklyInvoiceDate.get(0));
			System.out.println("B::: " +weeklyInvoiceDate.get(1));
			System.out.println("C ::: " +weeklyInvoiceDate.get(2));
			System.out.println("D ::: " +weeklyInvoiceDate.get(3));
			System.out.println("E ::: " +weeklyInvoiceDate.get(4));
		}
